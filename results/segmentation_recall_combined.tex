...
\hline
start.time & 2021-06-28 21:57:53\\
\hline
\end{tabular}
...
\citetext{\citealp{Aslin1998}; \citealp{Chen2015}; \citealp[Conway2005a;][]{Fiser2002}; \citealp{Hauser2001}; \citealp{Saffran-Science}; \citealp{Toro2005-backward}; \citealp{Turk-Browne-reversal}},
and might support a wide range of computations, especially during
language acquisition \citep{Aslin2012, Seidenberg2002}.
...
effect of local neural processing \citep[a ``spandrel'' in biological
terms;][]{Gould1979} that is sometimes adaptive, sometimes neutral and
...
encountered them and thus could now have memorized them
\citetext{\citealp[because the items are played
backwards;][]{Turk-Browne-reversal}; \citealp[see also][]{Jones2007}},
and sometimes even prefer high-TP items they have \emph{never}
encountered to low-TP items they have heard or seen
...
\citep[Bar2009;][]{Clark2013, Friston2010, Keller2018}.
...
the null hypothesis was 0.785 for initial syllables (3.606 for the
...
\hspace{1em}lab-based & \M = 0.615, \SE = 0.0476, \p = 0.0477 & \M = 0.923, \SE = 0.0455, \p = 0.00122 & 0.012\\
\hspace{1em}online & \M = 0.628, \SE = 0.0318, \p = 7.84e-05 & \M = 0.911, \SE = 0.0193, \p = 7.08e-15 & 0.000\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Number of items}}\\
\hspace{1em}lab-based & \M = 4.23, \SE = 0.756, \p = 0.00164 & \M = 4.23, \SE = 0.818, \p = 0.00152 & 0.812\\
...
\hspace{1em}lab-based & \M = 3.79, \SE = 0.421, \p = 0.00164 & \M = 2.97, \SE = 0.0246, \p = 0.000725 & 0.026\\
\hspace{1em}online & \M = 2.65, \SE = 0.0869, \p = 2.29e-14 & \M = 2.93, \SE = 0.0364, \p = 1.04e-15 & 0.000\\
\addlinespace[0.3em]
...
\hspace{1em}online & \M = 0.417, \SE = 0.105, \p = 0.424 (vs. 0.5); 0.189 (vs. 0.333333333333333) & \M = 1, \SE = 0, \p = 2.08e-13 (vs. 0.5); 2.08e-13 (vs. 0.333333333333333) & 0.000\\
\addlinespace[0.3em]
...
\hspace{1em}online & \M = 0.397, \SE = 0.0316, \p = 6.26e-12 & \M = 0.583, \SE = 0.04, \p = 3.82e-13 & \vphantom{1} 0.001\\
\addlinespace[0.3em]
...
\hspace{1em}online & \M = 0.767, \SE = 0.0459, \p = 4.8e-06 (vs. 0.5); 0.00154 (vs. 0.666666666666667) & \M = 0.97, \SE = 0.0187, \p = 7.01e-14 (vs. 0.5); 6.75e-13 (vs. 0.666666666666667) & 0.000\\
\addlinespace[0.3em]
...
\caption{Analyses of the participants' productions. (a)
...
\hspace{1em}lab-based & \M = 0.308, \SE = 0.139, \p = 0.0719 & \M = 1.85, \SE = 0.308, \p = 0.00224 & \vphantom{1} 0.005\\
\hspace{1em}online & \M = 0.224, \SE = 0.0791, \p = 0.00482 & \M = 1.32, \SE = 0.143, \p = 7.32e-11 & \vphantom{1} 0.000\\
\addlinespace[0.3em]
...
\hspace{1em}online & \M = 0.224, \SE = 0.0791, \p = 0.00482 & \M = 1.32, \SE = 0.143, \p = 7.32e-11 & 0.000\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Number of part-words}}\\
\hspace{1em}lab-based & \M = 0.692, \SE = 0.273, \p = 0.031 & \M = 0, \SE = 0, \p = NaN & \vphantom{1} 0.031\\
\hspace{1em}online & \M = 0.25, \SE = 0.0657, \p = 0.000717 & \M = 0, \SE = 0, \p = NaN & \vphantom{1} 0.000\\
\addlinespace[0.3em]
...
\hspace{1em}online & \M = 0.25, \SE = 0.0657, \p = 0.000717 & \M = 0, \SE = 0, \p = NaN & 0.000\\
\addlinespace[0.3em]
...
\hspace{1em}online & \M = 0.279, \SE = 0.0331, \p = 1.08e-09 & \M = 0.516, \SE = 0.0435, \p = 8.27e-12 & 0.000\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Number of Low-TP chunks}}\\
\hspace{1em}lab-based & \M = 0.0769, \SE = 0.0801, \p = 1 & \M = 0, \SE = 0, \p = NaN & 1.000\\
\hspace{1em}online & \M = 0.355, \SE = 0.0747, \p = 2.41e-05 & \M = 0.0395, \SE = 0.0226, \p = 0.149 & 0.000\\
\addlinespace[0.3em]
...
\hspace{1em}online & \M = 0.0855, \SE = 0.0198, \p = 6.04e-05 & \M = 0.00846, \SE = 0.00523, \p = 0.181 & 0.000\\
\bottomrule
