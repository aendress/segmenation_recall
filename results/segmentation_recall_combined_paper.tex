...
% Cohen1980, Rungratsameetaweemana2019
...
\caption{\label{tab:recall-all-results-print}Various analyses pertaining to the productions as well as test against their chances levels. The $p$ value in the rightmost column reflects a Wilcoxon test comparing the continuous and the pre-segmented conditions.}
\centering
\resizebox{\linewidth}{!}{
